...
//		struct DataNode
//		{
//			CMemoryPool<ObjectType>* underFlowGuard = nullptr;
//			ObjectType object;
//			CMemoryPool<ObjectType>* overFlowGuard = nullptr;
//			DataNode<ObjectType>* next = nullptr;
//			bool useFlag = false;
//		};
//	public:
//		//생성자 그냥 alloc을 n번 호출한것과 동일한효과 그 이후에 추가되는것도 free list처럼
//		CMemoryPool(int blockNum = 0, bool placementNew = false) : capacity(blockNum), useCount(0), placementNew(placementNew), pFreeNode(nullptr)
//		{
...
//			temp -= sizeof(CMemoryPool<ObjectType>*);
