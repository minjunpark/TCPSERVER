...
//
//---------------------------------------------------------------
struct st_dfPACKET_SC_CREATE_MY_CHARACTER
{
	int _Id;
	char _Direction;
	short _X;
...
//
//---------------------------------------------------------------
struct st_dfPACKET_SC_CREATE_OTHER_CHARACTER
{
	int _Id;
	char _Direction;
	short _X;
...
//
//---------------------------------------------------------------
struct st_dfPACKET_SC_DELETE_CHARACTER
{
	int _Id;
};
...
struct st_dfPACKET_CS_MOVE_START
{
	char _Direction;
	short _X;
	short _Y;
...
//
//---------------------------------------------------------------
struct st_dfPACKET_SC_MOVE_START
{
	int _Id;
	char _Direction;
	short _X;
...
//
//---------------------------------------------------------------
struct st_dfPACKET_CS_MOVE_STOP
{
	char _Direction;
	short _X;
	short _Y;
...
//
//---------------------------------------------------------------
struct st_dfPACKET_SC_MOVE_STOP
{
	int _Id;
	char _Direction;
	short _X;
