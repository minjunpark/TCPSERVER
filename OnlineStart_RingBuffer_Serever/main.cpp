...
//		{
//			continue;//죽어있는 유저에게는 데이터를 보내지 않는다.
//		}
//
...
//		//받은 크기만큼 세션에 전송한다.
//
//		retBro = send((*session_it)->sock, buffer, sendbuf_use, 0);//세션 소켓으로 바이트전송
//
...
//	}
//	
//	stmp->sendBuf->Enqueue(_Msg, sizeof(STAR_ID));//안들어가면 안들어가는데로 별상관없음 버퍼가 꽉찬거니까
//};
//
